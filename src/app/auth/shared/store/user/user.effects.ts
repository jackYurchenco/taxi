...
export class UserEffects {
	...
	createUser$: Observable<Payload<User>>;

	sendCodeToPhone$: Observable<Payload>;
	...
	getUser(actionType: string, actionTypeSuccess: string, actionTypeError: string): Observable<Payload<User>>{
	...
	createUser(actionType: string, actionTypeSuccess: string, actionTypeError: string): Observable<Action> {
    return createEffect(() => this._actions$.pipe(
			ofType(actionType),
